...
export class MahalleService {
  ...
  Ekle(mahalle: Mahalle): Observable<Mahalle> {
    return this.http
      .post<Mahalle>(this.baseURL + 'Add', mahalle, Helper.getHeader())
  ...
  GetirMahalle(skipDeger: number, takeDeger: number): Observable<Mahalle[]> {
    return this.http
      .get<Mahalle[]>(
        this.baseURL + 'GetAll/' + skipDeger + '/' + takeDeger,
        Helper.getHeader()
      )
      .pipe(catchError(this.handleError));
  }
  ...
  Duzenle(mahalle: Mahalle): Observable<Mahalle> {
    return this.http
      .put<Mahalle>(this.baseURL + 'Update', mahalle, Helper.getHeader())
      .pipe(catchError(this.handleError));
  }

  Getir(id: number): Observable<Mahalle> {
    return this.http
      .get<Mahalle>(this.baseURL + 'GetById/' + id, Helper.getHeader())
      .pipe(catchError(this.handleError));
  }
